...
class Home extends Component {
  ...
  filterSalesByMonth = (datas, targetMonth) =>
    datas.filter(sale => {
  ...
  render() {
    const {selectedMonth, allProductData, searchedInput} = this.state
    ...
    const totalSale = productData
      .filter(eachProduct => eachProduct.sold === 'true')
      .reduce((acc, eachProduct) => acc + eachProduct.price, 0)
      .toFixed(2)
    console.log(productData)
    const totalSoldItem = productData.filter(
      eachProduct => eachProduct.sold === 'true',
    ).length

    const totalNotSoldItem = productData.filter(
      eachProduct => eachProduct.sold === 'false',
    ).length
    ...
    return (
      <div className="bg-container">
        ...
        <div className="statics-container">
          <div className="stats-container">
            <div className="total-sale-container">
              ...
              <p className="count">{totalSale}</p>
            </div>
            <div className="total-sale-container">
              <p className="side-name">Total sold item</p>
              <p className="count">{totalSoldItem}</p>
            </div>
            <div className="total-sale-container">
              <p className="side-name">Total not sold item</p>
              <p className="count">{totalNotSoldItem}</p>
            </div>
          </div>
        </div>
        <h1 className="side-header">
        ...
        <MonthlyBarChart productData={productData} />
      </div>
    )
  }
}
